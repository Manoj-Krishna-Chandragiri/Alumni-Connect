  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#A8422F] via-[#C4503A] to-[#E77E69] rounded-xl p-6 text-white">
        ...
        <p className="text-rose-100 text-sm">Manage your administrator account</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="text-center sm:text-left flex-1">
            ...
            <p className="text-gray-500 mt-2 text-sm">VVIT Alumni Connect — Full Access</p>
          </div>
          {!editMode && (
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">Access Level</p>
                <span className="inline-flex items-center gap-1 text-indigo-700 font-medium text-sm">
                  <span className="w-2 h-2 rounded-full bg-indigo-500 inline-block" /> Full System Access
                </span>
              </div>
            </div>
          </div>
