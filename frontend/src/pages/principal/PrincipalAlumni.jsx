...
const PrincipalAlumni = () => {
  ...
  const fetchAlumni = async () => {
    try {
      ...
      const response = await principalApi.getAllAlumni(params);
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">
            View alumni records and engagement across all departments
          </p>
        </div>
...
export default PrincipalAlumni;
