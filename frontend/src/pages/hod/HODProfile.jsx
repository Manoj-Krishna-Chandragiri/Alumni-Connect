...
import {
  FiEdit2, FiMail, FiPhone, FiBriefcase, FiBook, FiUser, FiSave, FiX, FiShield,
} from 'react-icons/fi';
...
const DEPT_NAMES = {
  ...
  CSO: 'CSE with IoT',
  CIC: 'CSE with IoT and Cyber Security',
...
const HODProfile = () => {
  ...
  const deptName = DEPT_NAMES[user?.department] || user?.department || '';
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="text-center sm:text-left flex-1">
            ...
            {deptName && (
              <p className="text-gray-500 mt-2 text-sm flex items-center gap-1 justify-center sm:justify-start">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">Head of Department</p>
              </div>
            </div>
            {deptName && (
              <div className="flex items-center gap-3">
                <div className="p-2 bg-rose-50 rounded-lg"><FiBook className="w-5 h-5 text-rose-600" /></div>
                <div>
