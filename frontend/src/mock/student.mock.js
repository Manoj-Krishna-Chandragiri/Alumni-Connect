  ...
  recommendedAlumni: [
    {
      ...mockAlumni[0],
      matchScore: 92,
      matchReason: 'Similar skills in JavaScript, Python and interest in System Design',
    },
    {
      ...mockAlumni[2],
      matchScore: 88,
      matchReason: 'Same department and expertise in AWS, Microservices',
    },
    {
      ...mockAlumni[3],
      matchScore: 85,
      matchReason: 'Leadership skills and React expertise align with your career goals',
    },
  ],
  recommendations: [
    {
